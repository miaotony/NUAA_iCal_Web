...
if __name__ == "__main__":
    ...
    try:
        ...
        # with open('captcha.png', 'wb') as captcha_flle:
        #     captcha_flle.write(captcha_resp.content)

        # with open('captcha.png', 'rb') as captcha_flle:
        #     captcha_img = Image.open(captcha_flle)
        #     captcha_img.show()  # show the captcha

        # Convert format to fix the bug `OSError: cannot identify image file`
